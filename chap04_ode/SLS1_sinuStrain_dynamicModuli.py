...
if axisoption == "-log":
    savefile = "./png/SLS1_sinuStrain_dynamicModuli(log)_(epsilon={0:.2f},tau={1:.1f}s,E1={2:.1f}MPa,E2={3:.1f}MPa,eta={4:.1f}kPas).png".format(eamp,tau,E1/10**6,E2/10**6,eta/10**3)
else:
    savefile = "./png/SLS1_sinuStrain_dynamicModuli(linear)_(epsilon={0:.2f},tau={1:.1f}s,E1={2:.1f}MPa,E2={3:.1f}MPa,eta={4:.1f}kPas).png".format(eamp,tau,E1/10**6,E2/10**6,eta/10**3)
