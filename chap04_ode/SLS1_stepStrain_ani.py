# ordinary differential equation of SLS1 model (step strain) with animation
...
def init():               # FuncAnimationでinit_funcで呼び出す
    time_text.set_text('')
    return bar, rod, rod_sp1, rod_sp2, triangle1, triangle2, rod_da, damper, point, time_text
...
savefile = "./gif/SLS1_stepStrain_(epsilon={0:.2f},E1={1:.1f}MPa,E2={2:.1f}MPa,eta={3:.1f}kPas).gif".format(e0,E1/10**6,E2/10**6,eta/10**3)
