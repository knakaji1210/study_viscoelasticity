# complex modulus of SLS model 2
...
if __name__=='__main__':
    ...
    strMod = complexMod(insMod, k, relaxTime, freq)[0]  # E = insMod
    losMod = complexMod(insMod, k, relaxTime, freq)[1]  # E = insMod
    ...
    if select == 0:
        ...
        savefile = './png/SLS2_complex_modulus_linear.png'
    ...
    if select == 1:
        ...
        a = 1
        legend_loc='upper left'
        savefile = './png/SLS2_complex_modulus_log.png'
        try:
